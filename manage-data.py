...
def buttonHover(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input 4 unique digits")
...
def buttonHover2(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input ###-###-####")
...
def buttonHover4(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input yes or no")

def buttonHover5(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input granted or denied")

def buttonHover6(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input 1 unique digit")

def buttonHover7(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input LINKED employee ID and position ID")

def buttonHover8(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input 00:00:00")

def buttonHover9(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input year-month-day(####-##-##)")

def buttonHover10(e):
    button["bg"] = "white"
    status_label.config(text="Tip: Input (Y) if working (N) if they are off")
...
def insertThree():
    ...
    if answer:
        ...
        if (pID=="" or position=="" or positionTaken=="" or pswd=="" or directive=="" or privilege==""): #needs these parameters to execute
            ...
            con = mysql.connect(host="localhost", user="ms_user", password="manageuser", database="ManageEmp")
            cursor = con.cursor()
            cursor.execute("INSERT INTO Company VALUES('"+pID+"','"+position+"','"+privilege+"','"+pswd+"','"+positionTaken+"','"+directive+"')")
...
def updateThree():
    ...
    if answer:
        ...
        if (pID=="" or position=="" or positionTaken=="" or directive=="" or privilege==""): #needs all parameters to update even if all of them are not changed does NOT updates id
            ...
            con = mysql.connect(host="localhost", user="ms_user", password="manageuser", database="ManageEmp")
            cursor = con.cursor()
            cursor.execute("UPDATE Company SET position='"+position+"', privilege='"+privilege+"', pswd='"+pswd+"', positionTaken='"+positionTaken+"', directive='"+directive+"' WHERE pID='"+pID+"'")
            cursor.execute("commit")
...
positionTaken = Label(left_label, text="Taken:", font=('bold',14))
...
button = Button(root, text="",command=buttonHover)

status_label = Label(left_label, text='', bd=1, relief=SUNKEN, anchor=E)
status_label.pack(fill=X, side=BOTTOM, ipady=2)

e_eID.bind("<Enter>",buttonHover)
e_eID.bind("<Leave>",buttonHoverLeave)

d_eID.bind("<Enter>",buttonHover7)
d_eID.bind("<Leave>",buttonHoverLeave)

p_pID.bind("<Enter>",buttonHover6)
p_pID.bind("<Leave>",buttonHoverLeave)

d_pID.bind("<Enter>",buttonHover7)
d_pID.bind("<Leave>",buttonHoverLeave)

d_phone.bind("<Enter>",buttonHover2)
d_phone.bind("<Leave>",buttonHoverLeave)

d_ssn.bind("<Enter>",buttonHover3)
d_ssn.bind("<Leave>",buttonHoverLeave)

p_positionTaken.bind("<Enter>",buttonHover4)
p_positionTaken.bind("<Leave>",buttonHoverLeave)

p_privilege.bind("<Enter>",buttonHover5)
p_privilege.bind("<Leave>",buttonHoverLeave)

p_privilege.bind("<Enter>",buttonHover5)
p_privilege.bind("<Leave>",buttonHoverLeave)

e_startTime.bind("<Enter>",buttonHover8)
e_startTime.bind("<Leave>",buttonHoverLeave)

e_schedule_create.bind("<Enter>",buttonHover9)
e_schedule_create.bind("<Leave>",buttonHoverLeave)

e_endTime.bind("<Enter>",buttonHover8)
e_endTime.bind("<Leave>",buttonHoverLeave)

e_mon.bind("<Enter>",buttonHover10)
e_mon.bind("<Leave>",buttonHoverLeave)

e_tue.bind("<Enter>",buttonHover10)
e_tue.bind("<Leave>",buttonHoverLeave)

e_wed.bind("<Enter>",buttonHover10)
e_wed.bind("<Leave>",buttonHoverLeave)

e_thur.bind("<Enter>",buttonHover10)
e_thur.bind("<Leave>",buttonHoverLeave)

e_fri.bind("<Enter>",buttonHover10)
e_fri.bind("<Leave>",buttonHoverLeave)

e_sat.bind("<Enter>",buttonHover10)
e_sat.bind("<Leave>",buttonHoverLeave)

e_sun.bind("<Enter>",buttonHover10)
e_sun.bind("<Leave>",buttonHoverLeave)
